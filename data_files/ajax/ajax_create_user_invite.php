...
$invitation_code = mysqli_real_escape_string($db, $_POST['invitation_code']);
...
if(mysqli_query($db, $query)){
    echo "success";
    App::sendSMS($phone,"Congratulations! Your username is: $email and password is: $password");
    App::updateInvitationCode($invitation_code);
} else {
