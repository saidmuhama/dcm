        ...
        <div class="col-12 col-md">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-3 mb-md-0">
                    ...
                    <li class="breadcrumb-item bi"><a href="../data_files/?view=3002">Students</a></li>
                    <li class="breadcrumb-item active bi" aria-current="page">Add Student</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card adminuiux-card shadow-sm overflow-hidden mb-4" id="smartwizard2">
        <ul class="nav">
            <li class="nav-item"><a class="nav-link" href="#step-1">
                    <div class="num">1</div>
                    <div>
                        <p class="h5 mb-0">Student Details</p>
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                       <div class="col-12 col-lg-3 text-center mb-3">
                            <figure class="maxwidth-250 height-260 coverimg rounded position-relative mx-auto mb-3">
                                ...
                                <!-- IMAGE -->
                                 <?php 
                                 $iamgePath = App::getWhatFromWHere('image','tbl_students', 'usr_code',$usr_code);      
                                 ?>
                                <img id="previewImage" src="<?php echo $iamgePath;?>" alt="">
                            ...
                            <p class="small text-secondary" id="previewEmail"><?php echo App::getWhatFromWHere('role_title','tbl_user_roles', 'id',$user_role);?></p>
                        </div>
                        <div class="col">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="form-floating mb-3"><input class="form-control" id="tags1"
                                            placeholder="Enter Skill 1" value="Coding"> <label
                ...
                <div id="step-21" class="tab-pane px-0 pb-0" role="tabpanel" aria-labelledby="step-21">
                    <div class="row align-items-center mb-2">
                        <div class="col">
                            <p class="h6 py-2">Parent Contact</p>
                        </div>
                    </div>
                    <div class="row align-items-center mb-1">
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div class="form-floating mb-3"><input class="form-control" id="namefull"
                                    ...
                                    for="namefull">Parent Full Name</label></div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating mb-3"><input class="form-control" id="house1"
                                    placeholder="Enter House Owner Name"> <label for="house1">House Owner
                                    Name</label></div>
                            <div class="row mb-2">
                                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="form-floating mb-3"><input class="form-control" id="house3"
                                            placeholder="Enter House Number" value="101"> <label
                                            for="house3">House Number</label></div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                ...
                                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="form-floating mb-3"><input class="form-control"
                                            id="postcode" placeholder="Enter Postcode" value="787169">
                                        <label for="postcode">Postcode</label></div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                ...
                <div id="step-31" class="tab-pane px-0 pb-0" role="tabpanel" aria-labelledby="step-31">
                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col">
                            <p class="h6 py-2">Current Admission Details</p>
                        </div>
                        <div class="col-auto"></div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg col-xl mb-3">
                            <div class="form-floating">
                                <select class="form-select" id="main_academic_level">
                                    ...
                                    <?php 
                                        $sql = mysqli_query($db, "SELECT * FROM tbl_main_academic_levels");
                                        while ($course_type = mysqli_fetch_array($sql)) {
                                            echo '<option value="'.$course_type['id'].'">'.$course_type['level_title'].'</option>';
                                        }
                                    ?>
                                </select> 
                                <label for="uni-2a">Course Type</label></div>
                        </div>
                        <div class="col-12 col-md-6 col-lg col-xl mb-3">
                            <div class="form-floating">
                                <select class="form-select" id="sub_academic_level">
                                
                            </select> 
                                <label for="course-2a">Course/Degree</label></div>
                        </div>
...
document.getElementById("main_academic_level").addEventListener("change", function(){

    let main_id = this.value;

    // reset sub dropdown
    let subSelect = document.getElementById("sub_academic_level");
    subSelect.innerHTML = '<option>Loading...</option>';

    fetch("ajax/ajax_get_sub_levels.php", {
        method: "POST",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded"
        },
        body: "main_id=" + main_id
    })
    .then(res => res.text())
    .then(data => {
...
saveBtn.className = "btn btn-primary m-3";
saveBtn.innerText = "Save Student Details";
...
window.addEventListener("DOMContentLoaded", function(){
    ...
    fetch("ajax/ajax_get_student.php?id="+id)
    .then(res=>res.json())
    .then(res=>{
        ...
        document.getElementById("course-1a").value = res.course;
