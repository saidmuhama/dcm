<div class="container-fluid"><button class="btn btn-link btn-square sidebar-toggler" type="button"
                    ...
                    <div class=""><span class="h4">Digital<span class="fw-bold">CLass</span></span>
                        <p class="company-tagline">E-Leaning Platform</p>
                    </div>
                </a>
                <div class="flex-grow-1 px-3 justify-content-center">
                    <div
                        ...
                        <span class="input-group-text border-0 bg-none"><i class="bi bi-search"></i> </span><input
                            class="form-control border-0 bg-none" type="search" placeholder="Search here..."
                            id="searchglobal"></div>
                </div>
                <div class="ms-auto"><button class="btn btn-link btn-square btn-icon btn-link-header d-lg-none"
                        ...
                        <div class="dropdown-menu dropdown-menu-end width-300 pt-0 px-0 overflow-hidden">
                            ...
                            <div class="px-2">
                                <div class="row g-2 text-center mb-2">
                                    <div class="col-4"><a class="dropdown-item square-item position-relative" href="#">
                                            <div
                                                class="position-absolute start-0 top-0 h-100 w-100 rounded overflow-hidden coverimg z-index-0">
                                                <img src="../assets/img/learning/bg-overlay-1.png" alt=""></div>
                                            <div class="avatar avatar-40 rounded mb-2"><i
                                                    class="bi bi-bank fs-4 mx-0"></i></div>
                                    ...
                                    <div class="col-4"><a class="dropdown-item square-item position-relative" href="#">
                                            <div
                                                ...
                                                <img src="../assets/img/learning/bg-overlay-1.png" alt=""></div>
                                            <div class="avatar avatar-40 rounded mb-2"><i
                                                    class="bi bi-globe fs-4 mx-0"></i></div>
                                    ...
                                    <div class="col-4"><a class="dropdown-item square-item position-relative" href="#">
                                            <div
                                                ...
                                                <img src="../assets/img/learning/bg-overlay-1.png" alt=""></div>
                                            <div class="avatar avatar-40 rounded mb-2"><i
                                                    class="bi bi-box fs-4 mx-0"></i></div>
                            ...
                            <div class="text-center"><a class="btn btn-link text-center"
                                    href="https://www.adminuiux.com/adminuiux/learning-uiux/app-demo.html">View all <i
                    ...
                    <div class="dropdown d-inline-block"><button
                            ...
                            <span
                                class="position-absolute top-0 end-0 badge rounded-pill bg-danger p-1"><small>9+</small>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end notification-dd sm-mi-95px">
                            <li><a class="dropdown-item p-2" href="#">
                                    <div class="row gx-3">
                                        ...
                                        <div class="col">
                                            <p class="mb-2 small">Congratulation! Your admission <span
                                                    class="fw-bold">#H10215</span> has been processed successfully.</p>
                                            <span class="row"><span class="col"><span
                            ...
                            <li><a class="dropdown-item p-2" href="#">
                                    <div class="row gx-3">
                                        ...
                                        <div class="col">
                                            <p class="mb-2 small">Your assignment class 10<sup>th</sup> with IS <span
                                                    class="fw-bold">#H10215</span> checked now.</p><span
                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col">
                                            <p class="mb-2 small">User <span class="fw-bold">Rahana</span> has updated
                                                <span class="fw-bold">#H10215</span> <b>Harshita</b>'s Profile.</p><span
                                                class="row"><span class="col"><span
                                    ...
                                    <div class="row gx-3">
                                        ...
                                        <div class="col">
                                            <p class="mb-2 small">Your subscription going to expire soon. Please <a
                                                    href="https://www.adminuiux.com/adminuiux/learning-uiux/profile-subscription.html">upgrade</a>
                                                to get service interrupt free.</p>
                                            <p class="opacity-75 small">4 days ago</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="text-center"><button class="btn btn-link text-center">View all <i
                                        class="bi bi-arrow-right fs-14"></i></button></li>
                        </ul>
                    </div>
                            ...
                            <div class="row gx-0 d-inline-flex">
                                <div class="col-auto align-self-center">
                                    <figure class="avatar avatar-28 rounded-circle coverimg align-middle"><img
                                            src="<?php echo $userProfileImage; ?>" alt=""
                                            id="userphotoonboarding2"></figure>
                                </div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end width-300 px-0 sm-mi-45px"
                            aria-labelledby="userprofiledd">
                            <div class="px-2">
                                <a href="../data_files/?view=3002"
                                    class="dropdown-item">
                                    <div class="row gx-3">
                                        <div class="col-auto">
                                        ...
                                        <div class="col align-self-center">
                                            ...
                                            <p class="small"><i class="bi bi-trophy me-2"></i> <?php echo $roleTitle; ?></p>
                                        </div>
                                    </div>
                                </a></div>
                            <div class="px-2">
                                <div><a class="dropdown-item" href="../data_files/?view=change-password-request"><i data-feather="user"
                                            class="avatar avatar-18 me-1"></i> Change Password</a></div>
                                <div>
                                    <?php 
                                    if($user_role == 1){
                                        $profilePath = 'student_profile';
                                        $profileSetting = 'student_profile_completion';
                                    }
                                    elseif($user_role == 3){
                                        $profilePath = '3002';
                                        $profileSetting = 'teacher_profile_completion';
                                    }
                                    ?>
                                    <a class="dropdown-item" href="../data_files/?view=<?php echo $profilePath; ?>">
                                        <div class="row g-0">
                                            <div class="col align-self-center"><i data-feather="layout"
                                                    class="avatar avatar-18 me-1"></i> My Dashboard
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div>
                                    <a class="dropdown-item" href="../data_files/?view=<?php echo $profileSetting; ?>"">
                                    <i data-feather="settings" class="avatar avatar-18 me-1"></i> Account Setting</a>
                                </div>
                                <div>
                                    <a class="dropdown-item theme-red" href="../data_files/?view=kill-session-user">
                                        <i data-feather="power" class="avatar avatar-18 me-1"></i> Logout</a>
                                </div>
                            </div>
                        </div>
                    </div>
